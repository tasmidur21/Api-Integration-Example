## Use Case 04: Many to One
In the case, We think about a destributed system where the information are segregated. If any client want to fetch any information, they need to call multiple services and merge the response for presenting. We can solve the problem by calling one endpoint via ***WSO2 Micro Integrator*** and the ***Integrator*** fetches data from multiple services and aggregate itself and give the aggregated response.

We consider a diagram, where ***WSO2 Micro Integrator*** is used as the integration middleware that calls two service and aggregates the response.Finally,the  ***WSO2 Micro Integrator*** return the single response to end user.

![Integration Scenario](https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/dev-first-integration-0.png)
...
- The Grand Oak service accept GET requests in the following service endpoint url:
  ...
  ```
  Here DOCTOR_TYPE=Ophthalmologist AND Response: 
...
1.  Open WSO2 Integration Studio and click **New Integration Project** in the **Getting Started** view as shown below.
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/new-project/new-integration-project.png" title="New Integration Project" width="700" alt="New Integration Project"/>
...
3.  In the **New Integration Project** dialog box that opens, enter `Healthcare` for your integration project. This is a <b>maven multi module</b> project.
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/2-dev-get-started-integration-proj.png" width="500">
...
3. Click **Finish**. 
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/3-dev-get-started-proj-explorer.png" width="300">
...
1.  Right-click `HealthcareConfigs` and go to **New** → **Endpoint** to open the **New Endpoint Artifact** dialog box.
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/4-dev-get-started-select-endpoint.png" width="500">
...
3.  For the ‘Grand Oak hospital service’, let’s use the following values:
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/5-dev-get-started-grandoaks-endpoint.png" width="500">
...
3. Specify values for the required REST API properties:
    ...
    <table>
     ...
     <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/6-dev-get-started-rest-api.png" width="500">
...
5. Open the new artifact from the project explorer. You will see the graphical view of the `HealthcareAPI` with its default **API Resource**.
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/7-dev-get-started-api-canvas.png" width="700">
...
6. Double-click the API resource to open the **Properties** view:
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/8-dev-get-started-api-properties-view.png" width="700">
...
1. Create two parallel message flows:
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/9-dev-get-started-clone-mediator.png" width="700">
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/10-dev-get-started-clone-mediator-branches.png" width="300">
...
2. Invoke the GrandOak Endpoint:
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/11-dev-get-started-call-mediator.png" width="700">
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/12-dev-get-started-call-grandoaks.png" width="700">
...
3. Construct message payload for the PineValley Endpoint:
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/13-dev-get-started-payloadfactory-mediator.png" width="700">
    ...
    **Args** can be added using the **PayloadFactoryArgument** dialog box, which appears when you click the (<img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/tutorials/common/plus-icon.png" width="20">) sign.

    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/14-dev-get-started-payloadfactory-expression.png" width="700">
...
5. Aggregating response messages:
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/15-dev-get-started-aggregate-mediator.png">
...
6. Send a response back to the client :
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/16-dev-get-started-drop-mediator.png" width="700">
...
1. Right-click `HealthcareCompositeExporter` and click **Export Project Artifacts and Run**.
    ...
    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/17-dev-get-started-build-and-run-1.png" width="500">

2. You will see the following dialog box. Select the `HealthcareConfigs` folder in the artifact list and click **Finish**.

    <img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/18-dev-get-started-build-and-run-2.png" width="700">
...
<img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/19-dev-get-started-embedded-server-startup.png">
...
<img src="https://ei.docs.wso2.com/en/latest/micro-integrator/assets/img/developing-first-integration/20-dev-get-started-open-dashboard.png" width="500">
...
1.  Download the [`DoctorInfo-JDK11.jar` file](../apis/doctorinfo-jdk11.jar). This contains two healthcare services.
2.  Open a terminal, navigate to the location of the downloaded `DoctorInfo-JDK11.jar` file, and execute the following command to start the services:
    ...
    ```
3.  Open a terminal and execute the following curl command to invoke the service:
